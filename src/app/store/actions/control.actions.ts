...
export enum ControlActionTypes {
  ...
  AddToMyList = '[ Control ] AddToMyList',
  DeleteFromMyList = '[ Control ] DeleteFromMyList',
}
...
export class AddToMyList implements Action{
  readonly type = ControlActionTypes.AddToMyList;
  constructor(public payload: any) {}
}

export class DeleteFromMyList implements Action{
  readonly type = ControlActionTypes.DeleteFromMyList;
  constructor(public payload: any) {}
}